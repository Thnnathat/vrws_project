...
class GuideLine:
    def __init__(self) -> None:
        pass
        # self.img_width = image_res.width
        # self.img_height = image_res.height
        # self.center_frame = (self.img_width // 2, self.img_height // 2) # (width, height)
    # def draw_star_line_center_frame(self, image):
    #     cv2.line(image, (self._center_frame[0], 0), (self._center_frame[0], image.shape[0]), (0, 0, 255), 1)
    #     cv2.line(image, (0, self._center_frame[1]), (image.shape[1], self._center_frame[1]), (0, 0, 255), 1)
